...
public_users.get("/server/async-books", async function (req, res) {
    try {
...
public_users.get("/server/async-books/isbn/:isbn", function (req, res) {
    let { isbn } = req.params;
...
public_users.get("/server/async-books/author/:author", function (req, res) {
...
public_users.get("/server/async-books/title/:title", function (req, res) {
